...
* Diff-in-diff with state-year fixed effects, age>55 turnout share
// Table S11, Col 1
reghdfe share_votes55 treat, ///
...
* Diff-in-diff with state-year fixed effects and linear trends, age>55 turnout share
// Table S11, Col 2
reghdfe share_votes55 treat, ///
...
* Diff-in-diff with state-year fixed effects and quadratic trends, age>55 turnout share
// Table S11, Col 3
reghdfe share_votes55 treat, ///
...
quietly {
	cap log close
	set linesize 255
	log using "$root/output/age_effects_table.tex", text replace
	
	noi di "\begin{table}[h]"
	noi di "\centering"
	noi di "\caption{\textbf{Vote-by-Mail Expansion Does Not Appear Have Large Effects on Age Composition of the Electorate.}\label{tab:age_effects}}"
	noi di "\begin{tabular}{lccc}"
	noi di "\toprule \toprule"
	noi di " & \multicolumn{3}{c}{Turnout Share Age 55+ [0-1]}  \\"
	noi di " & (1) & (2) & (3)  \\"
	noi di "\midrule"
